...
edit: not "OreString" but "OreDictionary" doofus
*/
...
cassiterite.addOre("oreTin", 0.50);
// could throw abyssal tin ore (same oredict)
...
limonite.addOre("oreIron", 0.70);
limonite.addOre("oreNickel", 0.30);

//Malachite (Copper)
Excavator.addMineral("Malachite", 30, 0.15, [], [], [-1], true);
var malachite = Excavator.getMineral("Malachite");
malachite.addOre("oreCopper", 0.50);
